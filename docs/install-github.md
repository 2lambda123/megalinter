...
<!-- Updated configuration and usage instructions -->
<!-- Note about checking the GitHub Comment Reporter -->
<!-- Note about clicking on hyperlinks -->
<!-- Note about checking the GitHub Status Reporter --> 
---
...
- You can also **use it outside of GitHub Actions** (CircleCI, Azure Pipelines, Jenkins, GitLab, or even locally with a docker run) , and have status on Github Pull Request if <!-- Note about checking the GitHub Status Reporter -->
